...
let redBull = new createMenuItem("RedBull", 4.29, "Drinks");
let quesarito = new createMenuItem("Quesarito", 4.59, "Mexican");
let newyorkstrip = new createMenuItem("New York Strip", 25.99, "Dinner");
...
createReview("Michael", 5, "Wrote this review just to get a $5 dscount.")
...
function getReviewByIndex(reviews, index) {
  function getReviewByIndex(reviews, index) {
    console.log(`${reviews[index].name} gave the restaraunt a ${reviews[index].rating} star review, and their feedback was: ${reviews[index].feedback}`);
  }
}
